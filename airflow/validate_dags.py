...
# Mirror the two Composer env vars that DAGs depend on for path resolution.
# Both use setdefault so they're no-ops when the real Composer values are present.
